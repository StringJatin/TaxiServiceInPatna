...
import EditBlog from '../EditCity/EditCity';
const AllCity = ({selectedOption, setSelectedOption}) => {
      ...
      const handleDeleteClick = async (postId) => {
        try {
            ...
            if (response.ok) {
                ...
                alert('City post deleted successfully!');
  ...
  return (
    <>
     {!postData && (<div className={styles.container}>
